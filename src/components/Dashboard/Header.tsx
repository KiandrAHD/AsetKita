...
export default function Header({
    ...
    return (
        <header className="border-b border-white/10 bg-[#08111d]/75 backdrop-blur">
                ...
                <div className="ml-auto flex items-center gap-2">
                    <label className="hidden items-center gap-2 rounded-xl border border-white/10 bg-white/[.03] px-3 py-2 text-sm text-slate-400 sm:flex">
                        ...
                        <input
                            ...
                            className="w-32 bg-transparent outline-none placeholder:text-slate-500 transition-all focus:w-48"
                        />
                    </label>
                    <NotificationLink />
